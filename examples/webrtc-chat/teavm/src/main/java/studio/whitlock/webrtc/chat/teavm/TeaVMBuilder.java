...
public class TeaVMBuilder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // teaBuildConfiguration.additionalAssetsClasspathFiles.add("studio/whitlock/webrtc/chat/asset.extension");
...
//        };
        ...
        // TeaReflectionSupplier.addReflectionClass("studio.whitlock.webrtc.chat.reflect");
